            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12 text-center">
                        ...
                        <h2 class="mb-0">{{$category_title->title}}</h2>
                    </div>
        ...
        <section class="latest-podcast-section section-padding" id="section_2">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    @foreach($relatedEpisodes as $podcast)
                    <div class="col-lg-6 col-12 mb-4 mt-4 mb-lg-0">
                        <div class="custom-block d-flex">
                            <div class="">
                                <div class="custom-block-icon-wrap">
                                    ...
                                    <a href="detail-page.html" class="custom-block-image-wrap">
                                        <img src="{{asset('user/images/podcast/11683425_4790593.jpg')}}" class="custom-block-image img-fluid" alt="">
                            ...
                            <div class="custom-block-info">
                                ...
                                <p class="mb-0">{{Str::limit($podcast->description,45)}}</p>
